...
public:
    ...
    Switch(void*,
           const visuals::point& = visuals::default_position,
           const visuals::size& = visuals::default_size,
           const switch_control::state& = switch_control::state_default,
           const switch_control::size& = switch_control::size_default);
    ~Switch();
    ...
    bool Create(void*, const visuals::point&, const visuals::size&, const switch_control::state&, const switch_control::size&);
